...
datastory_name <- "oa_monitoring_2021"
...
# characters etc.)
# -> Don't put "datastory" at the start or end!
datastory_name_en <- "open-access-publications-monitoring-2021"
datastory_name_de <- "open-access-publikationen-monitoring-2021"
datastory_name_fr <- "publications-en-libre-acces-monitoring-2021"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "2021: strongest improvement in Open Access-share yet"
lead_en <-
  paste0(
    "As part of our monitoring, we evaluated 14,641 publications resulting ",
    "from SNSF-funded research published in 2021. Of these, 77% are ",
    "available in Open Access (OA). An unprecedented increase over the 63% ",
    "measured for 2020."
  )

# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Open Access im Jahr 2021: bisher grösste Steigerung"
lead_de <- 
  paste0(
    "Im Rahmen unseres Monitorings haben wir 14 641 im Jahr 2021 erschienene ",
    "Publikationen ausgewertet. Sie sind aus der vom SNF geförderten ",
    "Forschung hervorgegangen. Davon sind 77% frei zugänglich. ",
    "2020 betrug dieser Wert 63%."
  )

# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "L’Open Access a connu la plus forte progression enregistrée à ce jour en 2021"
lead_fr <-
  paste0(
    "Nous avons évalué 14 641 publications issues de la recherche financée ",
    "par le FNS en 2021. Parmi celles-ci, 77% sont disponibles en Open Access ",
    "(OA), représentant une augmentation sans précédent par rapport à 2020."
  )

# Contact persons, always (first name + last name)
contact_person <- c("Tobias Philipp", "Simon Gorin")
...
publication_date <- "2023-08-10 04:00:00"
